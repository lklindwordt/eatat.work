...
class Assets {
  ...
  public function register_styles() {
    // Register Styles
    wp_register_style( 'style-css', get_stylesheet_uri(), [], filemtime( EATATWORK_DIR_PATH . '/style.css'), 'all' );
  ...
  public function register_scripts() {
    // Register Scripts
    wp_register_script( 'main-js', EATATWORK_DIR_URI . '/assets/main.js', [], filemtime( EATATWORK_DIR_PATH . '/assets/main.js'), true );
